...
local about = Window:MakeTab({    Name = "公告",    Icon = "rbxassetid://16060333448",    PremiumOnly = false})about:AddParagraph("REhpoin脚本群364494103")about:AddParagraph("脚本群：364494103")about:AddParagraph("作者:回响")about:AddParagraph("作者师傅：L靓坤")about:AddParagraph("REhpoin脚本永远的神")about:AddParagraph("脚本创作时间为2025.1.13")local Tab =Window:MakeTab({	Name = "作者QQ群这里",	Icon = "rbxassetid://16060333448",	PremiumOnly = false})Tab:AddButton({	Name = "复制REhpoin脚本群",	Callback = function()     setclipboard("364494103")  	end})Tab:AddButton({	Name = "复制脚本群",	Callback = function()     setclipboard("364494103")  	end})OrionLib:MakeNotification({	Name = "回响",	Content = "欢迎使用REhpoin",	Image = "rbxassetid://16060333448",	Time = 2})
