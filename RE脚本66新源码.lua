...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="载入中"; Duration = 3; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="师傅是靓坤"; Duration = 3; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="感谢使用！载入成功"; Duration = 3; })
...
local UITab3 = win:Tab("越狱",'7734068321')
