...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="载入中"; Duration = 2; })wait("3")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="师傅是靓坤"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="载入成功"; Duration = 3; })
