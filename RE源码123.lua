...
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/xiaoSB33/ui-/raw/Ul（2）.lua", true))()
 local Window =   OrionLib:MakeWindow({Name = "REhpoin", HidePremium = false, SaveConfig = false, ConfigFolder = "rbxassetid://6026568198"}) 
...
LOL:AddLabel("作者：回响")
LOL:AddLabel("QQ：3240325167")
LOL:AddLabel("REhpoin群号：364494103")
LOL:AddLabel("此脚本永久免费，缝合脚本：如果你是买来的恭喜你被圈了")
LOL:AddLabel("如果加载出现错误，请进我的QQ群，进行反馈，谢谢！")
LOL:AddLabel("近期的更新通知：添加更多服务器脚本")

local Tab = Window:MakeTab({ 
 Name = "皮脚本", 
 Callback = function()
  loadstring(game:HttpGet("https://raw.githubusercontent.com/xiaopi77/xiaopi77/main/QQ1002100032-
Roblox-Pi-script.lua"))()
	end
})
local Tab =Window:MakeTab({
  Name = "情云脚本",    
